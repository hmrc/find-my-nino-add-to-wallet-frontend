...
final case class EncryptedAddressData(
  addressLine1: EncryptedAddressLine,
...
object EncryptedIndividualDetailsDataCache {
  ...
  val encryptedIndividualDetailsDataCacheFormat: OFormat[EncryptedIndividualDetailsDataCache] =
    ((__ \ "id").format[String]
      ...
      eiddc => Tuple3(eiddc.id, eiddc.individualDetailsData, eiddc.lastUpdated)
    )
